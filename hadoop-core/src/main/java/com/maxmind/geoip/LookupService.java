...
/**
 * Provides a lookup service for information based on an IP address. The location of a database file
 * is supplied when creating a lookup service instance. The edition of the database determines what
 ...
 * <p>
 *
 * <i>Tip:</i> Those deploying the GeoIP API as part of a web application may find it difficult to
 * pass in a File to create the lookup service, as the location of the database may vary per
 * deployment or may even be part of the web-application. In this case, the database should be added
 * to the classpath of the web-app. For example, by putting it into the WEB-INF/classes directory of
 * the web application. The following code snippet demonstrates how to create a LookupService using
 * a database that can be found on the classpath:
 *
 * <pre>
...
public class LookupService {
    ...
    private static final String[] countryCode = {"--", "AP", "EU", "AD", "AE", "AF", "AG", "AI", "AL", "AM", "AN", "AO", "AQ", "AR", "AS", "AT",
                    "AU", "AW", "AZ", "BA", "BB", "BD", "BE", "BF", "BG", "BH", "BI", "BJ", "BM", "BN", "BO", "BR", "BS", "BT", "BV", "BW", "BY",
                    "BZ", "CA", "CC", "CD", "CF", "CG", "CH", "CI", "CK", "CL", "CM", "CN", "CO", "CR", "CU", "CV", "CX", "CY", "CZ", "DE", "DJ",
                    "DK", "DM", "DO", "DZ", "EC", "EE", "EG", "EH", "ER", "ES", "ET", "FI", "FJ", "FK", "FM", "FO", "FR", "FX", "GA", "GB", "GD",
                    "GE", "GF", "GH", "GI", "GL", "GM", "GN", "GP", "GQ", "GR", "GS", "GT", "GU", "GW", "GY", "HK", "HM", "HN", "HR", "HT", "HU",
                    "ID", "IE", "IL", "IN", "IO", "IQ", "IR", "IS", "IT", "JM", "JO", "JP", "KE", "KG", "KH", "KI", "KM", "KN", "KP", "KR", "KW",
                    ...
                    "SZ", "TC", "TD", "TF", "TG", "TH", "TJ", "TK", "TM", "TN", "TO", "TL", "TR", "TT", "TV", "TW", "TZ", "UA", "UG", "UM", "US",
                    "UY", "UZ", "VA", "VC", "VE", "VG", "VI", "VN", "VU", "WF", "WS", "YE", "YT", "RS", "ZA", "ZM", "ME", "ZW", "A1", "A2", "O1",
                    "AX", "GG", "IM", "JE", "BL", "MF"};

    private static final String[] countryName = {"N/A", "Asia/Pacific Region", "Europe", "Andorra", "United Arab Emirates", "Afghanistan",
                    "Antigua and Barbuda", "Anguilla", "Albania", "Armenia", "Netherlands Antilles", "Angola", "Antarctica", "Argentina",
                    "American Samoa", "Austria", "Australia", "Aruba", "Azerbaijan", "Bosnia and Herzegovina", "Barbados", "Bangladesh", "Belgium",
                    "Burkina Faso", "Bulgaria", "Bahrain", "Burundi", "Benin", "Bermuda", "Brunei Darussalam", "Bolivia", "Brazil", "Bahamas",
                    ...
                    "Faroe Islands", "France", "France, Metropolitan", "Gabon", "United Kingdom", "Grenada", "Georgia", "French Guiana", "Ghana",
                    ...
                    "Virgin Islands, U.S.", "Vietnam", "Vanuatu", "Wallis and Futuna", "Samoa", "Yemen", "Mayotte", "Serbia", "South Africa",
                    "Zambia", "Montenegro", "Zimbabwe", "Anonymous Proxy", "Satellite Provider", "Other", "Aland Islands", "Guernsey", "Isle of Man",
     ...
     *
     * @param databaseFile String representation of the database file.
     * @throws java.io.IOException if an error occured creating the lookup service from the database
     *             file.
     */
     ...
     *
     * @param databaseFile String representation of the database file.
     * @param options database flags to use when opening the database GEOIP_STANDARD read database
     *            from disk GEOIP_MEMORY_CACHE cache the database in RAM and read it from RAM
     * @throws java.io.IOException if an error occured creating the lookup service from the database
     *             file.
     */
        ...
        for (i = 0; i < STRUCTURE_INFO_MAX_SIZE; i++) {
            ...
            if (delim[0] == -1 && delim[1] == -1 && delim[2] == -1) {
                ...
                if (databaseType == DatabaseInfo.REGION_EDITION_REV0) {
                    ...
                    recordLength = STANDARD_RECORD_LENGTH;
                } else if (databaseType == DatabaseInfo.CITY_EDITION_REV0 || databaseType == DatabaseInfo.CITY_EDITION_REV1
